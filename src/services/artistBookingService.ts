...
export function normalizeBooking(id: string, data: DocumentData): BookingEvent {
  ...
  return {
    ...
    budget: budgetNum,
    amount: budgetNum,
    artistOfferBudget: data.artistOfferBudget ? Number(data.artistOfferBudget) : (data.artistPayout ? Number(data.artistPayout) : undefined),
    artistPayout: data.artistPayout ? Number(data.artistPayout) : (data.artistOfferBudget ? Number(data.artistOfferBudget) : undefined),
    quotedPrice: data.quotedPrice ? Number(data.quotedPrice) : (data.artistOfferBudget ? Number(data.artistOfferBudget) : (data.artistPayout ? Number(data.artistPayout) : undefined)),
