...
export function SuggestionList({
  ...
  const localizedCategory = selectedCategoryForLocation ? getArtLabel(t, selectedCategoryForLocation) : "";
        ...
        <div className="p-2 space-y-2">
          <div className="flex items-center justify-between border-b border-stone-100 pb-2">
            <span className="text-xs font-extrabold text-stone-900 flex items-center gap-1.5">
              ...
              {t("search.selectLocationFor", { category: localizedCategory || selectedCategoryForLocation })}
            </span>
          </div>
          <div className="grid grid-cols-2 gap-1.5 pt-1">
            {topCities.map((city) => (
              ...
              >
                <span>{city === "All Cities" ? t("search.allCities") : city}</span>
