...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (authMethod === "masterKey") {
      ...
      if (!code) {
        toast({
          ...
          description: "Please enter the master passcode.",
        });
        return;
      }
    ...
    try {
      ...
      const isMasterAdminCred =
        isConfiguredAdmin ||
        rawUser === "vortex" ||
        rawUser === "admin" ||
        rawUser === "admin@mykalakar.com";
  ...
  const handleQuickAdminAccess = () => {
    ...
    toast({
      ...
      description: "Direct Master Admin Panel access authorized.",
    });
    navigate(destination, { replace: true });
  };
      ...
      <div className="w-full max-w-[420px] bg-white/95 border border-stone-200/90 backdrop-blur-xl rounded-2xl p-5 sm:p-6 shadow-xl shadow-stone-200/60 relative z-10 space-y-4">
        ...
        <div className="text-center space-y-1.5">
          ...
          <div>
            ...
            <p className="text-[11px] text-stone-500 font-medium">
              Manage artists, bookings, categories & platform operations.
            </p>
          </div>
        </div>
          ...
          {authMethod === "credentials" ? (
            <>
              ...
              <div className="flex items-center justify-between pt-0.5">
                ...
                <button
                  type="button"
                  onClick={() => applyPresetCredentials("admin12@gmail.com", "123456")}
        ...
        <div className="pt-3 border-t border-stone-100 space-y-2 text-center">
          ...
          >
            ...
            <span>Direct 1-Click Master Access</span>
          </Button>
        ...
        <div className="text-center pt-1 border-t border-stone-100 flex items-center justify-center gap-3 text-[11px] font-bold text-stone-500">
          ...
          <span className="text-stone-300">•</span>
          <Link to="/telecaller-login" className="hover:text-orange-600 transition">
            Telecaller
          </Link>
        </div>
      </div>
